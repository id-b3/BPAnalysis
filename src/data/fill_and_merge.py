...
df["gender"].fillna(df["gender_first"].fillna(df["gender_first2"]), inplace=True)
...
df["weight_at_scan"].fillna(
    df["bodyweight_kg_all_m_1_max2"].fillna(
...
df.drop(
    [
        "gender_first",
        "gender_first2",
        "bodyweight_kg_all_m_1_max2",
        "bodyweight_kg_all_m_1_max",
        "bodyweight_current_adu_q_1",
        "bodylength_cm_all_m_1_max2",
...
age_label_5 = ["45-50", "50-55", "55-60", "60-65", "65-70", "70-75", "75-80", "80+"]
age_cut_5 = np.linspace(45, 80, 8)
age_cut_5 = np.append(age_cut_5, 100)

df["age_5yr"] = pd.cut(df["age"], bins=age_cut_5, labels=age_label_5, right=False)

age_label_10 = ["45-54", "55-64", "65-74", "75-84", "85+"]
age_cut_10 = np.linspace(45, 85, 5)
age_cut_10 = np.append(age_cut_10, 100)

df["age_10yr"] = pd.cut(df["age"], bins=age_cut_10, labels=age_label_10, right=False)
...
df["ever_smoker"] = df["ever_smoker_adu_c_22"].fillna(
    df["ever_smoker_adu_c_2"].fillna(
        df["ever_smoker_adu_c_22_2"].fillna(
...
df["current_smoker"] = df["current_smoker_adu_c_22"].fillna(
    df["current_smoker_adu_c_2"].fillna(
        df["current_smoker_adu_c_22_2"].fillna(
            df["current_smoker_adu_c_22_3"].fillna(df["current_smoker_adu_c_22_4"])
        )
    )
)

df["ex_smoker"] = df["ex_smoker_adu_c_22"].fillna(
    df["ex_smoker_adu_c_2"].fillna(
        df["ex_smoker_adu_c_22_2"].fillna(
...
df["smoking_end-age"] = df["smoking_endage_adu_c_22"].fillna(
    df["smoking_endage_adu_c_2"].fillna(
        df["smoking_endage_adu_c_22_2"].fillna(
            df["smoking_endage_adu_c_22_3"].fillna(df["smoking_endage_adu_c_22_4"])
        )
    )
)
...
df["smoking_start-age"] = df["smoking_startage_adu_c_22"].fillna(
    df["smoking_startage_adu_c_2"].fillna(
        df["smoking_startage_adu_c_22_2"].fillna(
            df["smoking_startage_adu_c_22_3"].fillna(df["smoking_startage_adu_c_22_4"])
        )
    )
)
...
df["smoking_duration"] = df["smoking_duration_adu_c_22"].fillna(
    df["smoking_duration_adu_c_2"].fillna(
        df["smoking_duration_adu_c_22_2"].fillna(
            df["smoking_duration_adu_c_22_3"].fillna(df["smoking_duration_adu_c_22_4"])
        )
    )
)
...
df["max_cig_freq"] = df[
    [
        "cigarettes_frequency_adu_q_1_a",
        "cigarettes_frequency_adu_q_1",
        "cigarettes_frequency_adu_c_2",
    ]
].max(axis=1)
df["max_ciga_freq"] = df[
    [
        "cigarillos_frequency_adu_c_2",
        "cigarillos_frequency_adu_q_1",
        "cigarillos_frequency_adu_q_1_a",
    ]
].max(axis=1)
df["max_cigar_freq"] = df[
    [
        "cigars_frequency_adu_c_2",
        "cigars_frequency_adu_q_1",
...
df.loc[
    df.never_smoker.isna() & (~df.current_smoker.isna() & df.current_smoker)
    | (df.ever_smoker.notna() & df.ever_smoker)
    | (df.ex_smoker.notna() & df.ex_smoker),
    ["never_smoker"],
] = False
...
try:
    df.loc[
        (
            df.never_smoker.isna()
            & df.current_smoker.notna()
            & df.ever_smoker.notna()
            & df.ex_smoker.notna()
        )
...
df["pack_year_categories"] = pd.cut(
    df["pack_years"], bins=py_categories, labels=py_labels, right=False
)
...
df.drop(
    [
        ...
        "smoking_duration_adu_c_2",
        "smoking_duration_adu_c_22",
        "smoking_duration_adu_c_22_2",
        "smoking_duration_adu_c_22_3",
        ...
        "total_frequency_adu_c_12",
        "smoking_startage_adu_c_2",
        "smoking_startage_adu_c_22",
        "smoking_startage_adu_c_22_2",
        "smoking_startage_adu_c_22_3",
...
df["asthma_diagnosis"] = df["asthma_diagnosis_adu_q_1"].fillna(
    df["spirometry_astma_all_q_1_max"].fillna(
        df["spirometry_astma_all_q_1_max2"].fillna(df["elon_asthma_adu_q_06"])
    )
)
...
df["breathing_problems_adu_q_1"].replace([1, 2], ["BREATHING", "False"], inplace=True)

df["coughing_presence_adu_q_1"].replace([1, 2], ["COUGHING", "False"], inplace=True)

df["wheezing_presence_adu_q_1"].replace([1, 2], ["WHEEZE", "False"], inplace=True)

df["elon_wheeze_adu_q_01"].replace([1, 2], ["WHEEZE", "False"], inplace=True)

df["resp_other"] = df["wheezing_presence_adu_q_1"].fillna(
    df["elon_wheeze_adu_q_01"].fillna(
        df["coughing_presence_adu_q_1"].fillna(df["breathing_problems_adu_q_1"])
    )
)

df.drop(
    [
        "copd_presence_adu_q_1",
        "copd_presence_adu_q_2",
        "spirometry_copd_all_q_1_max",
        "spirometry_astma_all_q_1_max",
        "spirometry_astma_all_q_1_max2",
        "elon_copd_adu_q_13",
        "elon_asthma_adu_q_06",
        "asthma_diagnosis_adu_q_1",
        "cancer_type_adu_q_1",
        "cancer_type_adu_q_2",
        "breathing_problems_adu_q_1",
        "coughing_presence_adu_q_1",
        "wheezing_presence_adu_q_1",
...
df["fvc"] = df["spirometry_fvc_all_m_1_max2"].fillna(df["spirometry_fvc_all_m_1_max"])
...
df.drop(
    [
        "spirometry_fev1_all_m_1_max2",
        "spirometry_fev1_all_m_1_max",
        "spirometry_fvc_all_m_1_max",
        "spirometry_fvc_all_m_1_max2",
        "fev1_percpredicted_all_c_1_max2",
        "fev1_percpredicted_all_c_1_max",
        "fev1fvc_lowerlimit_all_c_1_max2",
        "fev1fvc_lowerlimit_all_c_1_max",
        "fev1_lowerlimit_all_c_1_max2",
        "fev1_lowerlimit_all_c_1_max",
        "fvc_lowerlimit_all_c_1_max2",
        "fvc_lowerlimit_all_c_1_max",
    ],
    inplace=True,
    axis=1,
)
...
emph_mask = (
    (df["centr_emph_wl_f"] > 0)
    | (df["pan_emph_wl_f"] > 0)
    | (df["para_emph_wl_f"] > 0)
    | df["thorax_remarks"].str.contains("emphyse")
    | df["thorax_remarks"].str.contains("bulla")
)
bronch_mask = df["thorax_remarks"].str.contains("bronchi") | df[
    "thorax_remarks"
].str.contains("mucus")
infection_mask = (
    df["thorax_remarks"].str.contains("infect")
    | df["thorax_remarks"].str.contains("pneumonia")
    | df["thorax_remarks"].str.contains("consolidati")
    | (df["inci_find___2"] == 1)
)

df["ild_signs"] = ild_mask
df["emphysema_signs"] = emph_mask
df["infection_signs"] = infection_mask
df["bronchi_signs"] = bronch_mask
